...
const HeroSection: FC = () => {
  ...
  return (
    <section>
      <div className="hero min-h-[calc(100vh-64px)]" id="hero">
        <div className="container flex-col lg:flex-row">
          <section className="font-jost w-full text-slate-900">
            <div className="flex justify-between gap-10">
              <div>
                <div className="mt-10 flex h-fit items-center pl-44">
                  ...
                  <h1 className="split pl-7 text-8xl">Analytics</h1>
                </div>
                <h1 className="pl-[40px] text-8xl">
                  that <span className="split text-gray-400">helps</span> you
                </h1>
              </div>
            ...
            <div className="ml-32 flex justify-center text-right">
              <h1 className="split text-8xl">shape</h1>
              ...
              <h1 className="split text-8xl">the future</h1>
            </div>
          </section>
        </div>
      </div>
